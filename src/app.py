...
#
#
# @app.route('/db/print_all_artist')
# def print_all_artist():
#     artist_list = Artist.query.all()
#     print_list = []
#     for artist in artist_list:
#         print_list.append(artist.json())
#     return jsonify(print_list)
#
#
# @app.route('/db/print_all_themes')
# def print_all_themes():
#     theme_list = Theme.query.all()
#     print_list = []
#     for theme in theme_list:
#         print_list.append(theme.json())
#     return jsonify(print_list)
#
#
